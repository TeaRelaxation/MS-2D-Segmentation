...
class WCEDiceFocalLoss(nn.Module):
    def __init__(self, class_weights, weight_ce=0.4, weight_dice=0.4, weight_focal=0.2):
        ...
        self.focal_loss = smp.losses.FocalLoss(mode="multiclass", alpha=class_weights.tolist())
